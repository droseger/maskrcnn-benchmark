...
# Gaussian Noise
_C.INPUT.GAUSSIAN_NOISE_LEVEL_TRAIN = 0.0
_C.INPUT.GAUSSIAN_NOISE_PROB_TRAIN = 0.0
_C.INPUT.GAUSSIAN_NOISE_LEVEL_TEST = 0.0
_C.INPUT.GAUSSIAN_NOISE_PROB_TEST = 0.0
...
# RoI-Pooler type, can be RoIPool or ROIAlign
